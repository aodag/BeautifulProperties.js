  ...
  describe(".define", function() {
    ...
    describe("descriptor",function(){
      describe("equals",function(){
        ...
        it("'change:key' event isn't triggered when it assign 'key' property and equals return false.",function(){
          BeautifulProperties.Observable.define(object,'key',{},{
            equals:function(val,previousVal){
              return false;
            }
        ...
        it("'change:key' event is triggered when it assign 'key' property and equals return true.",function(){
          BeautifulProperties.Observable.define(object,'key',{},{
            equals:function(val,previousVal){
              return true;
            }
